                            ...
                            <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST" action="{{ route('aboutupdate') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-center">
                                        <input type="text" id="nama-edit" name="nama-edit"  value="{{$editcameras->nama}}" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-center">
                                        ...
                                        <input type="text" id="link-edit" name="link-edit"  value="{{$editcameras->link}}" class="form-control" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-center">
                                        <input type="text" id="deskripsi-edit" name="deskripsi-edit"  value="{{$editcameras->deskripsi}}" class="form-control" required>
                                    </div>
                                </div>
