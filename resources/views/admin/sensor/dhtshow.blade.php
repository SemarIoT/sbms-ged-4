                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @foreach($about as $abouts)
                                    <h3 >API untuk DHT dan Lux Meter</h3>
                                <div class="row d-flex justify-content-center pt-0">
                                            ...
                                            <p class="text text-start mb-0 ">Method -> POST or GET</p><span>
                                            <p class="text text-start mb-0 ">Field  -> temperature, humidity, lux</p><span>
                                        </div> 
